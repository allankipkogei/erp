      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 p-10">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-10">
            <h1 className="text-5xl font-black bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">
              Equipment
            </h1>
            <Button
              className="bg-gradient-to-r from-amber-600 to-orange-600 text-white px-8 py-4 rounded-xl"
          ...
          {equipment.length === 0 ? (
            <div className="text-center py-24 bg-white rounded-3xl shadow-2xl">
              ...
              <Button
                className="bg-gradient-to-r from-amber-600 to-orange-600 text-white px-10 py-4 rounded-xl"
                onClick={() => navigate("/equipment/create")}
              >
                Add First Equipment
              </Button>
